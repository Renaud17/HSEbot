    ...
    while(flag==True):
        ...
        if (user_intent !=''):
            if (user_response == '/start'):
                ...
                return resp #+ "\n\n🎁CADEAU SURPRISE.🎁\nJe t'offre ce document HSE qui te servira pour tes TBM et répondre aux questions dont ma réponse te semble incorrecte je suis une intelligence artificielle et je peux faire des erreurs comme l'humain.😊:\n https://drive.google.com/file/d/10nDPjBZZX82XCQUZIlUCujc0PpYDlWhb/view?usp=sharing/download?force=true"+random.choice(book)
...
def main() -> None:
    """Start the bot."""
    updater = Updater("1836903308:AAHtERNcpC-aJjb6J86k2AUzzUu_rxlT53k")
